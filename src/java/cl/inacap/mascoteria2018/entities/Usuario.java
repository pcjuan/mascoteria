 ...
 */
package cl.inacap.mascoteria2018.entities;
...
@NamedQueries({
    ...
    , @NamedQuery(name = "Usuario.iniciarSesion", query = "SELECT u FROM Usuario u WHERE u.rutUser = :rutUser AND u.clave = :claveUser")
...
public class Usuario implements Serializable {
    ...
    public String toString() {
        return "cl.inacap.mascoteria2018.entities.Usuario[ rutUser=" + rutUser + " ]";
    }
